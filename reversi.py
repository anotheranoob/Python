...
class ReversiGame(Frame):
    ...
    def __init__(self,master,computerPlayer=None):
        ...
        if computerPlayer is not None:
            ...
            if isinstance(computerPlayer, list):
                self.computerPlayer = []
                for i in computerPlayer:
                    self.computerPlayer.append(self.colors.index(i))
            else:
    ...
    def update_display(self):
        ...
        elif self.board.get_player() in self.computerPlayer:
